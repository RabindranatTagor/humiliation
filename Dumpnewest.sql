...
INSERT INTO `customers` VALUES (1,'GAY TEST',7200256400,310020091),(2,'TRUE GAY TEST',7256891841,859073891),(3,'ULTIMATE GAY TEST',3847049847,864397643),(4,'GIGA DRILL BREAKER',1234567890,123456789),(5,'RICK ASTLEY',1234567899,123456788),(6,'KFC NIGGA',1233333345,123456777),(7,'OOO PINUS NIGRA',1234567890,123456789),(8,'I. C. Wiener',2324567890,234567890),(9,'Anal Staircase',56587980,342654756),(10,'SHITLOAD GAY',57090011992,112233445),(11,'UNBELIEVABLE GAY TEST',934857481029,345097068);
...
INSERT INTO `materials` VALUES (1,'SQUARE BLUE MASK',90,90),(2,'TRIANGLE WHITE MASK',90,100),(3,'ROUND BLUE MASK',90,100),(4,'PIPES 53MM',390,100),(5,'PIPES 76MM',470,100),(6,'BALLS OF STEEL',10000,92);
